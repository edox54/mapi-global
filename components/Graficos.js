...
export function GraficoADN() {
  return (
    <svg className="adn__grafico" viewBox="0 0 420 360" role="img" aria-label="Diagrama: base sólida y líneas ascendentes a 45 grados">
      ...
      <rect x="36" y="190" width="124" height="124" rx="27" fill="#0f2040" />

      <g stroke="#0f2040" strokeWidth="15" strokeLinecap="butt">
...
export function GraficoNodos() {
  ...
  return (
    ...
    <svg viewBox="0 0 640 320" className="nodos" role="img" aria-label="MAPI GLOBAL como marca institucional sobre cinco industrias">
      ...
      <text x="320" y="308" textAnchor="middle" fontSize="12" fill="#0f2040" fontWeight="700" letterSpacing="2">
        MAPI GLOBAL
      </text>
    </svg>
    </div>
...
// Bloque gráfico de ubicación — geométrico, sin API externa.
export function GraficoMapa() {
  return (
    <svg viewBox="0 0 480 300" role="img" aria-label="Representación esquemática de la ubicación corporativa">
      <rect width="480" height="300" fill="#0f2040" />
      ...
      <g stroke="rgba(255,255,255,0.34)" strokeWidth="6" fill="none">
      ...
      <circle cx="240" cy="150" r="26" fill="none" stroke="var(--acento)" strokeOpacity="0.75" strokeWidth="1" />
      <rect x="230" y="140" width="20" height="20" rx="6" fill="var(--acento)" />
      <text x="240" y="216" textAnchor="middle" fontSize="11" fill="var(--acento-claro)" opacity="0.9" letterSpacing="2">
        SEDE CORPORATIVA
      </text>
    </svg>
  );
